...
def apply_safe_schema_fixes():
    stmts = [
        ...
        "ALTER TABLE users ADD COLUMN steam_account_label VARCHAR(64)",
        "ALTER TABLE users ADD COLUMN steam_profile_url VARCHAR(255)",
        "ALTER TABLE users ADD COLUMN steam_id64 VARCHAR(32)",
        "ALTER TABLE users ADD COLUMN steam_display_name VARCHAR(128)",
        "ALTER TABLE users ADD COLUMN steam_avatar_url VARCHAR(500)",
